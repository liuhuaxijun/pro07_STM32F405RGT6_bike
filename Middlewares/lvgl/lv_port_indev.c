...
static void touchpad_clamp_xy(lv_indev_t *indev, int32_t *x, int32_t *y);
...
static void touchpad_read(lv_indev_t *indev_drv, lv_indev_data_t *data)
{
    ...
    if (touchpad_is_pressed())
    {
        ...
        touchpad_clamp_xy(indev_drv, &last_x, &last_y);
...
static void touchpad_get_xy(int32_t *x, int32_t *y)
{
    ...
    Int_CST816D_GetXY((uint16_t *)x, (uint16_t *)y);
}
